...
DOCDIR   = $(CMAKE_INSTALL_PREFIX)/share/doc/zstd
...
CMAKE_PARAMS += -DCMAKE_INSTALL_LIBDIR:STRING="$(LIBDIR)" -DCMAKE_INSTALL_MANDIR:STRING="$(MANDIR)" -DCMAKE_INSTALL_DOCDIR:STRING="$(DOCDIR)"
