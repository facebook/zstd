...
typedef struct ZSTDMT_DepThreadPoolJob_s ZSTDMT_DepThreadPoolJob;            /* Job management struct */
typedef struct ZSTDMT_DepThreadPoolThread_s ZSTDMT_DepThreadPoolThread;      /* Thread managedment struct */
typedef struct ZSTDMT_DepThreadPoolCtx_s ZSTDMT_DepThreadPoolCtx;            /* Context (one per thread pool) */
