                        ...
                        const U32 extDict)
{
    ...
    return ZSTD_insertBtAndGetAllMatches(zc, ip, iLimit, maxNbAttempts, mls, matches, minMatchLen, extDict);
}
...
*  Optimal parser
*********************************/
static void ZSTD_compressBlock_opt_generic(ZSTD_CCtx* ctx,
