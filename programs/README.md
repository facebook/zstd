...
--train-cover[=k=#,d=#,steps=#,split=#,finalize=#] : use the cover algorithm with optional args
--train-fastcover[=k=#,d=#,f=#,steps=#,split=#] : use the fastcover algorithm with optional args
